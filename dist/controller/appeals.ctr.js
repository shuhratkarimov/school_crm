            ...
            include: [
                {
                    ...
                    where: (0, branch_scope_helper_1.withBranchScope)(req, {}, "branch_id"), // ✅ filter Student.branch_id bo‘yicha
...
const getLastTenDayAppeals = async (req, res, next) => {
    try {
        ...
        const appeals = await appeal_model_1.default.findAll({
            where: {
                created_at: { [sequelize_1.Op.gte]: startOfDay },
            },
            include: [
                {
                    model: index_1.Student,
