  ...
  function Requests() {
    ...
    const fetchRequests = async () => {
      try {
        ...
        if (todayResponse.ok) {
          ...
          toast.success("Bugun hech qanday murojaat kelib tushmagan")
        ...
        if (allResponse.ok) {
          ...
          toast.success("Oxirgi 10 kunlik murojaat yo'q")
        } else {
    ...
    const sendReply = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          toast.success("O'quvchiga to'lov qilishi lozimligi haqida xabar yuborildi!");
    ...
    const deleteRequest = async (id) => {
      try {
        ...
        toast.success("Murojaat muvaffaqiyatli o'chirib tashlandi!");
      } catch (err) {
        setError("Murojaatni o'chirishda muammo yuzaga keldi. Iltimos, birozdan so'ng qayta urinib ko'ring!");
        toast.error("Murojaatni o'chirishda muammo yuzaga keldi. Iltimos, birozdan so'ng qayta urinib ko'ring!");
        console.error(err);
      }
    };
    ...
    const showDeleteToast = (id) => {
      toast(
        <div>
          <p>
            Diqqat! Ushbu murojaatni o'chirishga ishonchingiz komilmi?
          </p>
